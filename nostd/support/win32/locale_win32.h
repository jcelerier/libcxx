...
public:
    ...
    friend bool operator==(const locale_t& __left, std::std::nullptr_t) {
    ...
    friend bool operator==(std::std::nullptr_t, const locale_t& __right) {
    ...
    friend bool operator!=(const locale_t& __left, std::std::nullptr_t __right) {
        return !(__left == __right);
    }
    ...
    friend bool operator!=(std::std::nullptr_t __left, const locale_t& __right) {
        return !(__left == __right);
    }
